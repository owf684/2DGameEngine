...
class _EnemyEngine:
    ...
    def main_loop(self, render_buffer, GameObjects, PlayerEngine, GraphicsEngine):

        self.move_enemy(render_buffer, GameObjects, PlayerEngine, GraphicsEngine)

    def move_enemy(self, render_buffer, GameObjects, PlayerEngine, GraphicsEngine):
